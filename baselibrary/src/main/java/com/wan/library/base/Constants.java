...
public class Constants {
    ...
    public static final String ROUTE_PROJECT = "/main/ProjectFragment";
    public static final String ROUTE_SYSTEM = "/main/SystemFragment";
    public static final String ROUTE_MINE = "/main/mine";
}
